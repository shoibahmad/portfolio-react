...
| | |
|---|---|
| **Frontend** | React.js, Next.js, Vite, JavaScript (ES6+), Tailwind CSS, HTML/CSS |
| **Backend & APIs** | FastAPI, Django REST Framework, Flask, RESTful API Design, Asynchronous Services, Auth Flows, Service Contracts |
| **AI / LLM** | LLM Integration (Gemini, Claude API), Prompt Engineering, Model Evaluation, PyTorch, Scikit-learn |
| **Databases** | PostgreSQL, SQL, Relational Data Modeling, Firebase Firestore, IndexedDB |
| **Cloud & DevOps** | Google Cloud Platform (GCP), Microsoft Azure, Azure DevOps (CI/CD), Docker, Git/GitHub, Postman |
| **Core fundamentals** | Data Structures & Algorithms, OOP, System Design, Offline-First Architecture, Testing, Documentation |
| **Actively deepening** | TypeScript, Node.js, NestJS, RAG Pipelines, Vector Databases, AWS |
...
**Mike Agent AI** — Remote | Mar 2026 – Present

- Building agentic AI workflows: multi-step tool use, orchestration, and evaluation of model behaviour in production paths.

### Software Developer (Freelance)
**SecureEval AI** — Lucknow | Jan 2026 – Mar 2026

- Architected and delivered a dual-interface fullstack examination-integrity platform (React.js frontend, FastAPI backend), now live and in active daily use — owned end-to-end from design through deployment.
...
- Integrated MediaPipe Face Mesh and Gemini 1.5 for real-time multi-face detection and behavioral analysis, achieving 90%+ suspicious-activity detection precision.
...
**RuralHealthAI** — Remote | 2025 – 2026
...
### Web Sonar — Web Intelligence Engine
*Nov 2025 – Mar 2026*

- Built a scalable Python data pipeline (FastAPI, Scrapy, Playwright) across 50+ dynamic sources, achieving a 98% retrieval success rate at 10,000+ daily requests.
- Engineered 24 analyzer modules across 30+ analysis panels, integrating the Gemini API to extract structured insights from web data at scale.

### TruthGuard AI — Deepfake Detection System
*Aug 2025 – Oct 2025*

- Engineered a CNN-based deep learning model (PyTorch, OpenCV) achieving 92% accuracy on the FaceForensics++ benchmark, served through a tested FastAPI REST service with a live analytics dashboard.

### Med-AI Vigi — Adverse Drug Reaction Risk Predictor
*May 2025 – Oct 2025*

- Trained an XGBoost/Random Forest ensemble achieving an 87% F1-score, reducing false-negative rates by 18% over baseline.

> The full catalogue of 19 shipped projects is at [shoibahmad.in/projects](https://shoibahmad.in/projects).
...
- **Publication:** *IU CA Cross Platform Application* — published in IJSAT, November 2025
